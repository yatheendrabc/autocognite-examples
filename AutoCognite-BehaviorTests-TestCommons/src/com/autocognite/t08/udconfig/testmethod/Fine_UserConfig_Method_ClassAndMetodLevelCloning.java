...
@TestClass
@Clone(count=3, properties = {"class.common=classLevelValue1,classLevelValue2"})
public class Fine_UserConfig_Method_ClassAndMetodLevelCloning{
	private UserDefinedConfig classConfig = null;

	public Fine_UserConfig_Method_ClassAndMetodLevelCloning(UserDefinedConfig config){
